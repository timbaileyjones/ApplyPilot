...
```bash
git clone https://github.com/timbaileyjones/ApplyPilot.git
cd ApplyPilot
pip install -e ".[dev]"
...
1. Check existing [issues](https://github.com/timbaileyjones/ApplyPilot/issues) to avoid duplicating work
